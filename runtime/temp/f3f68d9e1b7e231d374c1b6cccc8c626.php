<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"C:\Users\admin\Desktop\tp5funtrue\public/../application/admin\view\index\index.html";i:1582807210;s:68:"C:\Users\admin\Desktop\tp5funtrue\application\admin\view\layout.html";i:1582621248;s:75:"C:\Users\admin\Desktop\tp5funtrue\application\admin\view\common\header.html";i:1582894254;s:75:"C:\Users\admin\Desktop\tp5funtrue\application\admin\view\common\footer.html";i:1582890982;}*/ ?>
	...
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="/static/admin/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName"><?php echo $userinfo['a_user']; ?></cite></a>
						<dl class="layui-nav-child">
							...
							<dd><a href="javascript:;" data-url="<?php echo url('admin/User/editpass'); ?>"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
							<!-- <dd><a href="javascript:;" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span class="layui-badge-dot"></span></a></dd> -->
							<!-- <dd pc><a href="javascript:;" class="functionSetting"><i class="layui-icon">&#xe620;</i><cite>功能设定</cite><span class="layui-badge-dot"></span></a></dd> -->
							<dd pc><a href="javascript:;" class="changeSkin"><i class="layui-icon">&#xe61b;</i><cite>更换皮肤</cite></a></dd>
							<dd><a href="<?php echo url('admin/User/logout'); ?>" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				...
				<p>你好！<span class="userName"><?php echo $userinfo['a_user']; ?></span>, 欢迎登录</p>
			</div>
			<!-- 搜索 -->
			...
			<div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this">
						<a href="javascript:;" data-url="" id="shouye"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p><span>copyright @2018 <?php echo $userinfo['a_user']; ?></span>　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-sm">捐赠作者</a></p>
		</div>
	</div>
