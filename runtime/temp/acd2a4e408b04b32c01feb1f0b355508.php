<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"C:\Users\admin\Desktop\tp5funtrue\public/../application/admin\view\article\artDetail.html";i:1582784650;}*/ ?>
...
<form class="layui-form layui-row layui-col-space10">
	<div class="layui-col-md9 layui-col-xs12">
			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input newsName" lay-verify="newsName" readonly>
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">作者</label>
					<div class="layui-input-block">
						<input type="text" class="layui-input author" lay-verify="author" readonly>
					</div>
				</div>
		...
		<div class="layui-form-item magb0">
			...
			<div class="layui-input-block">
				<textarea class="layui-textarea" id="content" readonly> </textarea>
			</div>
		</div>
	</div>
